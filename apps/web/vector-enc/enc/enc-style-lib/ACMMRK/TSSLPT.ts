...
const ACMMRK_TSSLPT_SYMBOL_0: SymbolLayerSpecification = {
...
const ACMMRK_TSSLPT_SYMBOL_1: SymbolLayerSpecification = {
    id: 'ACMMRK_TSSLPT_SYMBOL_1',
    type: 'symbol',
    ...SOURCE_DESC,
    filter: [
        'all',
...
const symbols: SymbolLayerSpecification[] = [ACMMRK_TSSLPT_SYMBOL_0, ACMMRK_TSSLPT_SYMBOL_1]
